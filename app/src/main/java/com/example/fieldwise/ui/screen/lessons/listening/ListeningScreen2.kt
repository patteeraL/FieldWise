...
fun ListeningScreen2(
    ...
    val question = "Q1"
    val listenData = getDataListen2(language, course, lesson, question)
    val audioUri1: Uri?
    val audioUri2: Uri?
    val audioUri3: Uri?
    val audioUri4: Uri?
    ...
    if (listenData.isNotEmpty() && listenData[0].status) {
        ...
        Column(
            ...
            Column(
                ...
                MainButton(
                    button = "CONTINUE",
                    onClick = { //CHECK COMPLETENESS OF MATCHING BY CHECKING IF buttonStatus01-buttonStatus14 IS ALL TRUE OR NOT
                        NextExercise() },
