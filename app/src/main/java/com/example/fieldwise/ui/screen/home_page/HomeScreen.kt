...
import com.example.fieldwise.ui.widget.QuizResumeDrop
    ...
    Box(
        ...
        Column(
            ...
            Column(modifier = Modifier.fillMaxWidth()) {
                Row { QuizResumeDrop(title = "Lesson 1", description = "Consumer and Producer Behavior",cardType = CardType.BLUE, progress = 1f, complete = true, NavigateToLessons = NavigateToLessons)}
                Spacer(modifier = Modifier.height(30.dp))
                Row { QuizResumeDrop(title = "Lesson 2", description = "Consumer and Producer Behavior1",cardType = CardType.PURPLE, progress = 1f, complete = false, NavigateToLessons = NavigateToLessons)}
